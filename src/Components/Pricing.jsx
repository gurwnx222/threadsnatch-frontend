...
const Pricing = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-6 ">
      <div className="max-w-md w-full rounded-2xl shadow-lg p-6 text-center transition-transform duration-300 transform hover:scale-105 bg-white text-black">
        ...
        <p className="text-base mb-6 text-justify text-gray-600">{plan.text}</p>
