  ...
  return (
    <div className="relative font-montserrat min-h-screen">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen p-5">
        ...
        />
        <PhilosophyCard
          name="Meet Yash – Our Frontend Maestro"
          description={
            <>
              While I was juggling exam preparations and backend development, my
              talented friend Yash Chandan stepped in to create an exceptional
              frontend experience for our project. At 21 and in his final year
              of college, Yash brings a wealth of knowledge in React and the
              full MERN stack, blending modern design with robust functionality.
              Connect to him at{" "}
              <a
