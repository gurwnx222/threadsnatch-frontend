  ...
  return (
    <>
      <div className="bg-gray-50 min-h-screen font-montserrat flex flex-col">
        <Navbar />
        <main className="flex-grow mt-20 px-4 md:px-6 py-10 md:py-16 flex justify-center my-6">
          <div className="w-full max-w-5xl bg-black shadow-xl rounded-2xl p-6 md:p-10">
            <header className="text-center mb-12">
              <h1 className="text-4xl font-bold text-white">Terms of Use</h1>
              <p className="text-sm text-white mt-2">
                Effective Date: 7-12-2024
              </p>
              <p className="mt-4 max-w-2xl mx-auto text-base text-white">
                By accessing or using the ThreadSnatch API, you agree to comply
              ...
              {[
                {
                  ...
                  content: [
                    ...
                    <ul key="use-api-ul" className="list-disc ml-6 space-y-1">
                      ...
                      <li>
                        Violate intellectual or privacy rights of Threads users.
                      </li>
                      <li>
                        Misuse or resell data in breach of Threads’ terms.
                      </li>
                    </ul>,
                  ],
                },
                ...
                },
                {
                  ...
                  content: [
                    ...
                    <span key="email" className="font-medium text-black">
                      threader.tech@gmail.com
                    </span>,
                  ],
                },
              ].map((section, index) => (
            ...
            <p className="mt-12 text-center text-sm text-white border-t pt-6">
              By using the ThreadSnatch API, you confirm that you have read,
